...
main()
{
	outputColor = color;
        ...
        void initProgram()
        {
            ...
            LoadShader(vertexShader, ShaderType.VertexShader, pgmID, out vsID);
            LoadShader(fragmentShader, ShaderType.FragmentShader, pgmID, out fsID);
        ...
        private void LoadShader(string v, ShaderType type, int program, out int address)
        {
            address = GL.CreateShader(type);
            GL.ShaderSource(address, v);
            GL.CompileShader(address);
            GL.AttachShader(program, address);
            Console.WriteLine(GL.GetShaderInfoLog(address));
        }
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            //if (Focused && OpenTK.Input.Mouse.GetState().LeftButton == ButtonState.Pressed)
            //{
